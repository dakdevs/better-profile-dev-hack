		...
		<div className="min-h-screen bg-gray-50 p-8 dark:bg-gray-900">
			...
			<div className="grid grid-cols-2 gap-8 md:grid-cols-4">
				{states.map(({ state, label, error }) => (
					...
					>
						<h3 className="mb-4 text-lg font-semibold text-gray-700 dark:text-gray-300">{label}</h3>
			...
			<div className="mt-12">
				<h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">Disabled State</h2>
				<div className="flex justify-center">
					<VoiceInputButton
						state="idle"
			...
			<div className="mt-12">
				...
				<div className="mx-auto max-w-md">
					<div className="flex items-center space-x-4 rounded-lg bg-white p-4 shadow dark:bg-gray-800">
						<input
							type="text"
							placeholder="Type a message..."
							className="flex-1 rounded-full border border-transparent bg-gray-100 px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none dark:bg-gray-700 dark:text-gray-200"
						/>
						<VoiceInputButton
							state="idle"

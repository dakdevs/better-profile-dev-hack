	...
	return (
		<div className="fixed right-4 bottom-4 z-50">
			<button
				...
				className="rounded-full bg-blue-500 px-3 py-2 text-sm font-medium text-white shadow-lg transition-colors hover:bg-blue-600"
			>
				🎤 Debug
			</button>
					...
					<div className="space-y-3">
						...
						<div className="space-y-2">
							<div className="flex items-center space-x-2">
								<span
									className={`h-3 w-3 rounded-full ${isVoiceInputSupported() ? 'bg-green-500' : 'bg-red-500'}`}
								></span>

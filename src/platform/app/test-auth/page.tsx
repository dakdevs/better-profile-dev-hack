...
export default async function TestAuthPage() {
	...
	return (
		<div className="container mx-auto p-8">
			<h1 className="mb-4 text-2xl font-bold">Better Auth + Drizzle Integration Test</h1>

			<div
				className={`rounded-lg p-4 ${result.success ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
			>
				{result.success ? (
					<div>
			...
			<div className="mt-8">
				<h2 className="mb-4 text-xl font-semibold">Integration Details</h2>

...
const mockJobs = [
	{
		...
		description:
			"We're looking for a senior full stack developer to join our growing team. You'll work on cutting-edge web applications using modern technologies and frameworks.",
		requiredSkills: [
	...
	},
	{
		...
		company: 'StartupXYZ',
		description:
			"Join our fast-paced startup as a frontend developer. You'll be responsible for creating beautiful, responsive user interfaces using React and modern CSS frameworks.",
		requiredSkills: [
	...
	},
	{
		...
		description:
			'We need a skilled backend developer to work on our data processing pipelines and API services. Experience with Python and cloud technologies is essential.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			"Looking for a DevOps engineer to manage our cloud infrastructure and CI/CD pipelines. You'll work with containerization, orchestration, and monitoring tools.",
		requiredSkills: [
	...
	},
	{
		...
		company: 'InnovateLab',
		description:
			"Perfect opportunity for a recent graduate or career changer. You'll work alongside senior developers on various projects and learn modern development practices.",
		requiredSkills: [
	...
	},
	{
		...
		description:
			"Develop cross-platform mobile applications using React Native. You'll work on consumer-facing apps with millions of users.",
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Build and maintain data pipelines for our analytics platform. Work with large-scale data processing and machine learning infrastructure.',
		requiredSkills: [
			{ name: 'Python', proficiencyScore: 80 },
	...
	},
	{
		...
		description:
			"Create beautiful and intuitive user interfaces. You'll work closely with designers to implement pixel-perfect designs using modern CSS and JavaScript.",
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Develop and deploy machine learning models in production. Work on cutting-edge AI applications and research projects.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Protect our systems and data from security threats. Monitor, analyze, and respond to security incidents and vulnerabilities.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Design and implement scalable cloud architectures. Lead cloud migration projects and optimize infrastructure costs.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Develop and maintain automated testing frameworks. Ensure software quality through comprehensive testing strategies.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Manage and optimize database systems. Ensure data integrity, performance, and security across multiple database platforms.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Ensure system reliability and performance at scale. Build monitoring, alerting, and automation tools for production systems.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Develop decentralized applications and smart contracts. Work on innovative blockchain solutions and cryptocurrency platforms.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Create engaging mobile and PC games using Unity. Work on gameplay mechanics, graphics, and user experience.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Create technical documentation for software products. Work with engineering teams to document APIs, user guides, and technical specifications.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Lead product development for our SaaS platform. Work with engineering, design, and business teams to deliver user-focused features.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Manage and maintain IT infrastructure. Handle server administration, network management, and system security.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Design software architecture for enterprise applications. Lead technical decisions and mentor development teams.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Design and implement network infrastructure. Manage routers, switches, firewalls, and network security protocols.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Conduct cutting-edge AI research. Develop novel algorithms and contribute to scientific publications in machine learning and artificial intelligence.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Develop software for Internet of Things devices. Work on embedded systems, sensor integration, and device communication protocols.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Customize and develop Salesforce applications. Work on Apex, Lightning components, and integrations with third-party systems.',
		requiredSkills: [
	...
	},
	{
		...
		description:
			'Build and maintain developer platforms and tooling. Focus on developer experience, CI/CD, and infrastructure automation.',
		requiredSkills: [

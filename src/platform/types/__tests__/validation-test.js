...
const candidateSkills = [{ name: 'JavaScript' }, { name: 'React' }, { name: 'Node.js' }]

const requiredSkills = [{ name: 'JavaScript' }, { name: 'React' }]

const preferredSkills = [{ name: 'TypeScript' }, { name: 'Node.js' }]
...
console.log(
	'Time slot conflict detection (overlapping):',
	isTimeSlotConflict(slot1, slot2) ? 'PASS' : 'FAIL',
)
console.log(
	'Time slot conflict detection (non-overlapping):',
	!isTimeSlotConflict(slot1, slot3) ? 'PASS' : 'FAIL',
)

...
export interface GetRecruiterAnalyticsResponse
	extends ApiResponse<{
		activeJobs: number
		totalCandidates: number
...
export interface GetCandidateAnalyticsResponse
	extends ApiResponse<{
...
// Error handler type
export type ErrorHandler = (error: unknown, req: Request, context: ApiContext) => Response

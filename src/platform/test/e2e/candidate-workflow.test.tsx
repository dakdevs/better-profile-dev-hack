...
describe('Candidate End-to-End Workflow', () => {
	...
	describe('Complete Availability Setup Workflow', () => {
		...
		it('should handle availability conflicts gracefully', async () => {
			...
			// Check for overlap
			const hasOverlap =
				new Date(conflictScenario.newSlot.startTime)
					< new Date(conflictScenario.existingSlot.endTime)
				&& new Date(conflictScenario.newSlot.endTime)
					> new Date(conflictScenario.existingSlot.startTime)

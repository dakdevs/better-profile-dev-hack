...
describe('Recruiter End-to-End Workflow', () => {
	...
	describe('Complete Interview Scheduling Workflow', () => {
		it('should schedule interviews with mutual availability', async () => {
			...
			const recruiterAvailability = [{ start: '2024-02-15T09:00:00Z', end: '2024-02-15T17:00:00Z' }]
			const candidateAvailability = [{ start: '2024-02-15T10:00:00Z', end: '2024-02-15T12:00:00Z' }]

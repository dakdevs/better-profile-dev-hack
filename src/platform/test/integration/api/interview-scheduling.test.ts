...
import { DELETE, GET as GetInterview } from '~/app/api/interviews/[id]/route'
	...
	describe('PUT /api/interviews/[id]/confirm', () => {
		...
		it('should confirm interview', async () => {
			...
			const request = new NextRequest(
				'http://localhost:3000/api/interviews/test-interview-id/confirm',
				{
					method: 'PUT',
		...
		it('should return 404 when interview not found', async () => {
			...
			const request = new NextRequest(
				'http://localhost:3000/api/interviews/nonexistent-id/confirm',
				{
					method: 'PUT',
					body: JSON.stringify(confirmData),
					headers: { 'Content-Type': 'application/json' },

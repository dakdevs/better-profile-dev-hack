	...
	describe('Safari Browser Support', () => {
		...
		it('should handle Safari-specific limitations gracefully', async () => {
			...
			mockBrowserInfo = {
				...
				guidance:
					'Safari desktop has limited speech recognition support. For best experience, use Safari on iOS or switch to Chrome/Edge.',
			}
	...
	describe('Firefox Browser Support', () => {
		beforeEach(() => {
			...
			mockBrowserInfo = {
				...
				guidance:
					'Voice input is not supported in Firefox. Please use Chrome, Edge, or Safari for voice input functionality.',
				recommendedBrowsers: ['Chrome', 'Edge', 'Safari'],
			}
		})
	...
	describe('Insecure Context Handling', () => {
		beforeEach(() => {
			...
			mockBrowserInfo = {
				...
				guidance:
					'Voice input requires a secure context (HTTPS). Please access this site over HTTPS to use voice input.',
				recommendedBrowsers: ['Chrome', 'Edge', 'Safari'],
			}
		})

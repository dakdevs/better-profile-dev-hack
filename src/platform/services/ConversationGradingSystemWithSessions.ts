...
export class ConversationGradingSystemWithSessions
	implements IConversationGradingSystemWithSessions
{
	private sessionManager: SessionManager
	private currentSessionId: string
	private sessionSystems: Map<string, ConversationGradingSystem> = new Map()

	constructor(initialSessionId?: string, persistenceConfig?: PersistenceConfig) {

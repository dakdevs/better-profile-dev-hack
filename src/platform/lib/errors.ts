...
export class SchedulingError extends BaseError {
	...
	constructor(message: string, conflicts?: any[], suggestedAlternatives?: any[]) {
...
export class ExternalServiceError extends BaseError {
	...
	constructor(message: string, service?: string, retryable: boolean = true, originalError?: Error) {

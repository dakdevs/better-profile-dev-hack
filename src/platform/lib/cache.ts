...
export const cacheKeys = {
	...
	skillExtraction: (text: string, context?: string) =>
		`skills:extract:${cacheUtils.generateContentHash(text + (context || ''))}`,
	...
	mutualAvailability: (candidateId: string, recruiterId: string) =>
		`availability:mutual:${candidateId}:${recruiterId}`,
}
